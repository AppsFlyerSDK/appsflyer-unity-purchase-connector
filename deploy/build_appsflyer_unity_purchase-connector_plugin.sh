...
PACKAGE_NAME="appsflyer-unity-purchase-connector-1.0.1.unitypackage"
mkdir -p $DEPLOY_PATH
...
-quit \
&& echo "Package exported successfully to output/appsflyer-unity-purchase-connector-1.0.1.unitypackage" \
