...
PACKAGE_NAME="appsflyer-unity-purchase-connector-2.1.11.unitypackage"
mkdir -p $DEPLOY_PATH
...
-quit \
&& echo "Package exported successfully to output/appsflyer-unity-purchase-connector-2.1.11.unitypackage" \
